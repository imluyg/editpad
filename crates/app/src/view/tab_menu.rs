...
impl Editpad {
    ...
    pub(super) fn tab_context_panel(&self, idx: usize) -> Element<'_, Message> {
        ...
        panel = panel.push(
            button(
                container(
                    text(self.t(editpad_core::Key::TabSave))
                        .size(uipx)
                        .font(uifont),
                )
                .width(Fill),
            ...
            .width(Fill)
            .style(chrome_menu_item_style)
            .on_press_maybe((interactive && tab.dirty).then_some(Message::SaveTabFromMenu(idx))),
        );
        ...
        panel = panel.push(
            button(
                container(
                    text(self.t(editpad_core::Key::TabCopyPath))
                        .size(uipx)
                        .font(uifont),
                )
                .width(Fill),
            ...
            .width(Fill)
            .style(chrome_menu_item_style)
            .on_press_maybe((interactive && named).then_some(Message::CopyFilePath(Some(idx)))),
        );
        panel = panel.push(
            button(
                container(
                    text(self.t(editpad_core::Key::TabCopyName))
                        .size(uipx)
                        .font(uifont),
                )
                .width(Fill),
            ...
            .width(Fill)
            .style(chrome_menu_item_style)
            .on_press_maybe((interactive && named).then_some(Message::CopyFileName(Some(idx)))),
        );
        ...
        panel = panel.push(
            button(
                container(
                    text(self.t(editpad_core::Key::TabClose))
                        .size(uipx)
                        .font(uifont),
                )
                .width(Fill),
            ...
            .width(Fill)
            .style(chrome_menu_item_style)
            .on_press_maybe((interactive && !tab.pinned).then_some(Message::CloseTabAt(idx))),
        );
